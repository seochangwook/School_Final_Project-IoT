 ...
 */
public class Service_Activity_LED_2_OFF extends Service
{
    int service_number;
    ...
    public void onDestroy()
    {
        ...
        Log.i("Service Log", "LED service LED 2 off onDestroy()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Log.i("Service Log", "service 2 LED off onStartCommand()");
        ...
        if(service_number == 1)
        {
            ...
            Log.i("Service Log", "service LED 2 OFF");
