 ...
 */
public class Dust_Info_Activity extends ActionBarActivity
{
    TextView server_info_text;
    TextView current_dust;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.dust_info_activity_layout);
        ...
        current_dust = (TextView)findViewById(R.id.current_dust);
    ...
    public class Service_NetworkTask extends AsyncTask<Void, String, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                while(true)
                {
                    ...
                    //5번 서비스 이용, 먼지센서를 이용한 데이터 센싱//
                    trans_data_format += "5" +"/" + "5" + "/" + "" + "1" + "/" +"G" +".";
                    ...
                    Thread.sleep(5000); //18초에 한번씩 온도 갱신//
                }
            }
        ...
        protected void onProgressUpdate(String... values)
        {
            ...
            try
            {
                ...
                current_dust.setText(sensor_value+"%");

                //해당 센서의 데이터값에 따른 조건분기//
                if(sensor_value >=10 && sensor_value <= 30)
                {
                    info_1.setText("적절한 미세먼지 농도 입니다");
                    info_2.setText("쾌적함");
                    info_3.setText("1. 현재의 미세먼지 농도를 유지");
                }

                else
                {
                    info_1.setText("농도 계산 중..");
                    info_2.setText("농도 계산 중..");
                    info_3.setText("농도 계산 중..");
                }
            }
