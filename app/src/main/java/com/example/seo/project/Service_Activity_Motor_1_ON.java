 ...
 */
public class Service_Activity_Motor_1_ON extends Service
{
    int service_number;
    ...
    public void onDestroy()
    {
        ...
        Log.i("Service Log", "motor service motor 1 on onDestroy()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Log.i("Service Log", "service 1 motor on onStartCommand()");
        ...
        if(service_number == 1)
        {
            ...
            Log.i("Service Log", "service motor 1 on start!!");
    ...
    public class Service_NetworkTask_Motor_1 extends AsyncTask<Void, String, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                ...
                //6번 서비스 이용, 2번 아두이노의 2번 모터(일반 서보모터를 ON(1)한다//
                trans_data_format += "6" +"/" + "2" + "/" + "" + "2" + "/" +"1" +".";
