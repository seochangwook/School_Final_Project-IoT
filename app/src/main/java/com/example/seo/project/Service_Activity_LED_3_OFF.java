 ...
 */
public class Service_Activity_LED_3_OFF extends Service
{
    int service_number;
    String service_number_str;

    public Service_NetworkTask_LED_3 sensor_task_1;
    ...
    public void onDestroy()
    {
        ...
        Log.i("Service Log", "LED service LED 3 off onDestroy()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Log.i("Service Log", "service 3 LED off onStartCommand()");
        ...
        if(service_number == 1)
        {
            ...
            Log.i("Service Log", "service LED 3 OFF");

            sensor_task_1 = new Service_NetworkTask_LED_3(ip_address, port_number);
    ...
    public class Service_NetworkTask_LED_3 extends AsyncTask<Void, String, Void>
    {
        String dstAddress;
        int dstPort;
        String response;

        Service_NetworkTask_LED_3(String addr, int port)
        {
            dstAddress = addr;
            dstPort = port;
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                ...
                //5번 서비스 이용, 1번 아두이노의 8번 센서(LED 3)를 OFF(1)한다.//
                trans_data_format += "5" +"/" + "1" + "/" + "" + "8" + "/" +"0" +".";
