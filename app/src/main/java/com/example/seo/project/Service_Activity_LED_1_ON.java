 ...
 */
public class Service_Activity_LED_1_ON extends Service
{
    int service_number;
    ...
    public void onDestroy()
    {
        ...
        Log.i("Service Log", "LED service LED 1 on onDestroy()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Log.i("Service Log", "service 1 LED on onStartCommand()");
        ...
        if(service_number == 1)
        {
            ...
            Log.i("Service Log", "service LED 1 ON");
    ...
    public class Service_NetworkTask_LED_1 extends AsyncTask<Void, String, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                ...
                //5번 서비스 이용, 1번 아두이노의 6번 센서(LED 1)를 ON(1)한다.//
                trans_data_format += "5" +"/" + "1" + "/" + "" + "9" + "/" +"1" +".";
