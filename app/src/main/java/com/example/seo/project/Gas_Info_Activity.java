 ...
 */
public class Gas_Info_Activity extends ActionBarActivity
{
    TextView server_info_text;
    TextView current_gas_value;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gas_info_activity_layout);
        ...
        current_gas_value = (TextView)findViewById(R.id.current_gas);
    ...
    public class Service_NetworkTask extends AsyncTask<Void, String, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                while(true)
                {
                    ...
                    //5번 서비스 이용, 가스센서를 이용한 데이터 센싱//
                    trans_data_format += "5" +"/" + "4" + "/" + "" + "1" + "/" +"G" +".";
                    ...
                    Thread.sleep(5000); //12초에 한번씩 온도 갱신//
                }
            }
        ...
        protected void onProgressUpdate(String... values)
        {
            ...
            try
            {
                ...
                current_gas_value.setText(sensor_value+"%");

                //해당 센서의 데이터값에 따른 조건분기//

				if(sensor_value >= 500 && sensor_value <= 650)
                {
                    info_1.setText("정상 가스수치 입니다");
                    info_2.setText("이상없음");
                    info_3.setText("1. 문을 열어 환기를 시키세요");
                }

                else
                {
                    info_1.setText("가스수치 계산중입니다..");
                    info_2.setText("가스수치 계산중입니다..");
                    info_3.setText("가스수치 계산중입니다..");
                }
            }
