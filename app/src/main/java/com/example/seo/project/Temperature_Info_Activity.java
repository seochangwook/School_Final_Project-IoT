 ...
 */
public class Temperature_Info_Activity extends ActionBarActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.temperature_info_activity_layout);
    ...
    public class Service_NetworkTask extends AsyncTask<Void, String, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            try
            {
                while(true)
                {
                    ...
                    //5번 서비스 이용, 온도센서를 이용한 데이터 센싱//
                    trans_data_format += "5" +"/" + "3" + "/" + "" + "2" + "/" +"G" +".";
        ...
        protected void onProgressUpdate(String... values)
        {
            ...
            try
            {
                ...
                current_temp.setText(sensor_value+"º");

                //해당 센서의 데이터값에 따른 조건분기//

				if(sensor_value >= 20 && sensor_value <= 27)
                {
                    info_1.setText("적절한 실내온도 입니다");
                    info_2.setText("쾌적함");
                    info_3.setText("1. 현재 온도를 유지하세요");
                }

                else
                {
                    info_1.setText("온도 계산중..");
                    info_2.setText("온도 계산중..");
                    info_3.setText("온도 계산중..");
                }
            }
